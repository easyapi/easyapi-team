<template>
  <div class="m-wrapper team-new clearfix">
    ...
    <main>
      ...
      <Row>
        <Col span="4" class="key"><p><br></p></Col>
        <Col span="20">
          <ea-button class="new-btn" :disabled="urlOccupy" text="创建团队" type="main" @click="createTeam"/>
          <ea-button class="cancel-btn" text="取消" type="main" @click="cancelCreate"/>
        </Col>
      </Row>
    </main>
    <footer>
      <p>加入其他团队？ 请让管理员给您发送邀请链接，即可加入。 <a href="https://www.easyapi.com/help/" target="_blank">查看帮助</a></p>
    </footer>
  </div>
</template>
