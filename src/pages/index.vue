    ...
    <div class="team-hl">
      <div class="team-head">
        <div class="team-head-right">
          ...
          <span style="padding-left: 10px;" v-if="team.name">{{team.name}}</span>
        </div>
        <div class="team-head-left" v-if="authenticationToken">
          <span id="showTeamInfo"  style="cursor: pointer" >
             <img v-if="accountInfo.photo" class="team-icon" :src="accountInfo.photo" alt="" style="width:24px;height: 24px;border-radius: 20px">
          </span>
        ...
        <div class="team-head-left" v-if="!authenticationToken">
          <a href="https://account.easyapi.com"
             style="color: #fff;font-size: 14px;line-height: 50px;padding-right:20px;">登录</a>
          <a href="https://account.easyapi.com/signup" style="color: #fff;font-size: 14px;line-height: 50px;">注册</a>
        </div>
      </div>

      <div class="team-content">
        <p class="team-content-la" v-if="team!=null&& team!==''">
          欢迎来到{{team.name}}开发者主页</p>
        <p class="team-content-la" v-if="team!=null&& team!==''">
          {{team.description}}</p>
