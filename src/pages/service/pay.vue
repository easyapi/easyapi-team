  ...
  <div class="Insequence">
    ...
    <div class="Insequence_conter">
      <div class="Insequence_service">
        ...
        <div class="left">
          <div
            ...
            :key="i"
            @click="
              selectMoneyFn(price.num, price.id, null, price.price)
            "
          >
            <strong>
      ...
      <div class="Insequence_fl">
        <strong class="Insequence_service_title">{{type==2?'剩余次数：':'到期时间：'}}</strong>
        <div class="frequency">
          <strong style="color: #323232;font-size: 14px;">{{ type==2?num:dateFormat(date) }}</strong>
        </div>
      </div>
      <div class="Insequence_fl">
